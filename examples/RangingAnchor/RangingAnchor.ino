...
//定义测距周期
#define TIME_RANGING_PERIOD   (500) //测距周期
...
void setup() 
{
    ...
    DW1000.setDeviceAddress(0x0001);//设置设备短地址
    DW1000.setNetworkId(0x1234);//设置网络ID
    DW1000.commitConfiguration();//提交完成设置
   // DW1000.setSNIFFMode(0,0,0);//取消sniff模式，正常接收
    DW1000.setReceiveFrameWaitTimeoutPeriod(0);//设置接收超时时间
